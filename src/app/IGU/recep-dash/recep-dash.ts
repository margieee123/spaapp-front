  ...
  template: `
    <div class="min-h-screen bg-[#131313] flex items-center justify-center">
      <div class="text-center">
        <span class="material-symbols-outlined text-[#e3c190] text-6xl mb-6 block">contact_phone</span>
        <h1 class="text-4xl font-bold text-[#e3c190] mb-2">Bienvenido a la interfaz de Recepcionista</h1>
...
export class DashboardRecepComponent implements OnInit {
  nombre: string = '';
